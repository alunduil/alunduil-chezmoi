...
foot --version                             # terminal (built from source, script/install/foot)
foot-theme-auto --dry-run                  # confirms the daylight theme switch resolves coordinates
systemctl --user is-active foot-theme-auto.timer
```
